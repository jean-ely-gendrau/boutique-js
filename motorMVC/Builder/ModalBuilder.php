...
class ModalBuilder extends AbstractModalBuilder
{
    ...
    public function render()
    {
        $output =
            '<div id="' .
            $this->idModal .
            '" tabindex="-1" class="fixed top-0 bottom-0 left-0 right-0 z-50 hidden w-full bg-white/50 p-4 m-0 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">';
