...
class Slider
{
    ...
    {
        // shadow-[3px_3px_9px_0px_rgba(0,0,0,0.6)]
        $slider = "
        ...
        foreach ($products as $productItem):
            $slider .= "  <div class='bg-gray-100 dark:bg-gray-200 w-60 h-80 inline-block relative text-center m-2.5 rounded-xl shadow-inner dark:shadow-black'>
