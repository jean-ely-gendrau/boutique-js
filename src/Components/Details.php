...
class Details
{
    ...
    public function DetailsProduct($detail)
    {
        // Ensemble des images
        $productView = "<div class='font-[sans-serif]'>
      <div class='p-6 lg:max-w-7xl max-w-2xl max-lg:mx-auto'>
        ...
        // Nom et prix
        $productView .= "<h2 class='text-2xl font-extrabold text-gray-800'>{$detail->name}</h2>
            <div class='flex flex-wrap gap-4 mt-4'>
              <p class='text-gray-800 text-xl font-bold'>{$detail->price}€</p>
              <p class='text-gray-400 text-xl'><strike>{$detail->price}€</strike> <span class='text-sm ml-1'>Taxe inclus</span></p>
            </div>";
        ...
        // Description
        $productView .= "<div class='mt-8'>
              <h3 class='text-lg font-bold text-gray-800'>A Propos de ce produit :</h3>
