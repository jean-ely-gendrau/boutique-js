...
class SearchForm extends Render {
    private $serverName;
...
<form class="max-w-lg mx-auto">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        <div class="relative w-full">
            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-e-lg border-s-gray-50 border-s-2 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-s-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500" placeholder="Rechercher votre cafe ou the" required />
...
<script>
    var serverName = "<?php echo $this->serverName; ?>";
</script>
<script src="http://<?= $this->serverName ?>/assets/js/search.js"></script>
<?php
