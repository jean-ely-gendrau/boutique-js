  ...
  <header>
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
      <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div
          class="flex font-medium md:justify-end items-center md:order-3 space-x-3 rtl:space-x-reverse md:w-72 lg:w-80">
          <button type="button" class="rounded-full h-6 w-6 md:h-7 md:w-7 lg:h-8 lg:w-8 2xl:h-9 2xl:w-9 mx-2"
            data-js="darkSwitch,click">
        ...
        <a href="/" class="flex items-center space-x-3 md:order-2">
          <img src="http://<?= $serverName ?>/assets/images/tea-coffee.png" class="h-10 md:h-12 lg:h-14 xl:h-16"
            alt="TeaCoffe Logo" />
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
          <ul
            class="flex flex-col font-medium text-xs md:text-sm lg:text-base 2xl:text-lg md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            <li>
              <a href="/"
                class="block py-2 px-2 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500"
            ...
            <li>
              <a href="/contact"
                class="block py-2 px-2 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Contact</a>
            </li>
          </ul>
        </div>
      </div>
