 ...
 <footer class="bg-white dark:rounded-lg shadow dark:border dark:bg-gray-800 dark:border-gray-700 dark:mx-2">
     ...
     <div class="flex flex-row justify-center dark:text-white">
         <p><a href="/assets/pdf/CGU.pdf" class="mr-2" target="_blank">CGU</a></p>
         <p><a href="/assets/pdf/CONDITIONS_GÉNÉRALES_DE_VENTE_TEACOFFEE.pdf" target="_blank" class="ml-2">CGV</a></p>
     </div>
