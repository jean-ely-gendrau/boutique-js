...
foreach ($mostSell as $sellMost):
    ...
    ?>
    <div id="<?= $sellMost['id_product'] ?>" class="bg-gray-100 w-60 h-80 inline-block relative text-center m-2.5 rounded-x1">
        <div
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="18px" class="fill-gray-800 inline-block" viewBox="0 0 64 64">
                path d="M45.5 4A18.53 18.53 0 0 0 32 9.86 18.5 18.5 0 0 0 0 22.5C0 40.92 29.71 59 31 59.71a2 2 0 0 0 2.06
                0C34.29 59 64 40.92 64 22.5A18.52 18.52 0 0 0 45.5 4ZM32 55.64C26.83 52.34 4 36.92 4 22.5a14.5 14.5 div0 1
                26.36-8.33 2 2 0 0 0 3.27 0A14.5 14.5 0 0 1 60 22.5c0 14.41-22.83 29.83-28 33.14Z" data-original="#000000">
                </path>
            </svg>
        </div>
        <img id="<?= $sellMost['id_product'] ?>" class="article-image"
            src="http://<?= $serverName ?>/assets/images/<?= $sellMost['images']['main'] ?>" alt="<?= $sellMost["name"] ?>">
...
<div class="mx-auto flex justify-start max-w-6x1">
    <form method="post">
        ...
        <select name="counterSubCat" id="counterSubCat" onchange="checkSelection()">
            <option value="99">ici que ça se passe</option>
...
if (isset($counterSubCat)):
    ...
    foreach ($products as $product):
        ...
        <div id="<?= $product['id_product'] ?>" class="bg-gray-100 w-60 h-80 inline-block relative text-center m-2.5 rounded-x1">
            <div
                class="bg-grav-200 w-10 h-10 flex items-center justify-center rounded-full cursor-pointer absolute top-4 right-4">
                <svg xmlns='http://www.w3.org/2000/svg' width='18px' class='fill-gray-800 inline-block' viewBox='0 0 64 64'>
                    path d="M45.5 4A18.53 18.53 0 0 0 32 9.86 18.5 18.5 0 0 0 0 22.5C0 40.92 29.71 59 31 59.71a2 2 0 0 0 2.06
            ...
            <img id="<?= $product['id_product'] ?>" class="article-image"
                src="http://<?= $serverName ?>/assets/images/<?= $product['images']['main'] ?>" alt="<?= $product["name"] ?>">
