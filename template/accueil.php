...
<!-- TODO Créer une classe Carousel  -->
  <div id="carousel-exemple" class="relative md:max-w-[85rem] mx-auto" data-carousel="slide">
    <!-- Carousel wrapper -->
    <div class="relative h-56 overflow-hidden rounded-lg md:h-[34rem] w-11/12 mx-auto">
      <!-- Item 1 -->
      <div id="carousel-indicator-1" class="hidden duration-900 ease-in-out" data-carousel-item>
        <div
      ...
      <!-- Item 2 -->
      <div id="carousel-indicator-2" class="hidden duration-900 ease-in-out" data-carousel-item>
        <img
          src="http://<?= $serverName ?>/assets//images//banière//HomeCoffee.jpg"
          class="absolute block w-full h-full rounded-3xl max-h-[32rem] -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
          alt="..."
        />
      </div>
      <!-- Item 3 -->
      <div id="carousel-indicator-3" class="hidden duration-900 ease-in-out" data-carousel-item>
        <img
      ...
      <!-- Item 4 -->
      <div id="carousel-indicator-4" class="hidden duration-900 ease-in-out" data-carousel-item>
        <img
