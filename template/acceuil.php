...
<h2>Dernier produit de la boutique</h2>

<div id="menu" class="relative flex justify-center">
  <ul class="block list-none p-0 whitespace-nowrap overflow-hidden w-9/12">
    <div class="bg-gray-100 w-60 h-80 inline-block relative text-center m-2.5 rounded-xl">
    ...
    <img src="http://<?= $serverName ?>/assets/images/coffee1.webp" alt="image de café" class="w-32 h-28 mx-auto mt-12"/>
    <p class="mt-3 font-bold">Expresso Elegante</p>
    <div class="flex justify-center">
    <p class="mt-3 font-bold mr-2">$10</p>
    <p class="mt-3 font-medium text-gray-300">$10</p>
    </div>
    <div><button type="button" class="w-48 mt-4 px-4 py-3 bg-[#333] hover:bg-[#222] text-white rounded-full">Add to cart</button> </div>
