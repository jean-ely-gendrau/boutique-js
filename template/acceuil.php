<!-- <main class="bg-scroll" style="background-image: url('http://<?= $serverName ?>/assets/images/bg-acceuil.png')"> 
    ...
    <ul class="block list-none p-0 whitespace-nowrap overflow-hidden max-w-6xl px-[20px]">
      ...
      <div class="bg-gray-100 w-60 h-80 inline-block relative text-center m-2.5 rounded-xl">
        ...
        <div class="flex justify-center">
          <p class="mt-3 font-bold mr-2">
            <?= $productItem['price'] ?>€
          </p>
          <p class="mt-3 font-medium text-gray-300">
            <?= $productItem['price'] ?>€
          </p>
        </div>
        <div>
