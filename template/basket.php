            ...
            <?php foreach ($panier as $item): ?>
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    <td class="p-4">
                        ...
                        <img src="http://<?= $serverName ?>/assets/images/<?= $item->url_image ?>" class="w-16 md:w-32 max-w-full max-h-full">
                    </td>
                    ...
                    <td class="px-6 py-4">
                        <a href="remove_from_cart.php?id=<?= $item->id ?>" class="font-medium text-red-600 dark:text-red-500 hover:underline">Remove</a>
                    </td>
                </tr>
            <?php endforeach; ?>
