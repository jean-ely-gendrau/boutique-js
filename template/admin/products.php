    ...
    <div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
      ...
      <div class="overflow-x-auto">
        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tbody>
            <!-- START TR -->
            <?php foreach ($productsAllPaginate as $idKey => $product) : ?>
              <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <th scope="row" class="flex items-center px-4 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                  <img src="http://<?= $serverName ?>/assets/images/<?= $product->getImages()->main; ?>" alt="<?= $product->name ?>" class="w-auto h-8 mr-3">
                  <?= $product->name ?>
                </th>
                <!-- CATEGORY/SUB_CAT -->
                <td class="px-4 py-2">
                  <span class="bg-primary-100 text-primary-800 text-xs font-medium px-2 py-0.5 rounded dark:bg-primary-900 dark:text-primary-300"><?= $product->id_category ?> (<?= $product->id_sub_cat ?>)</span>
                </td>
                <!-- PRICE -->
                <td class="px-4 py-2">
