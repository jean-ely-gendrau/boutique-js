...
class Slider
{
    ...
    {
        return "
                      <button  data-js='handelScrollX,click' data-direction-scroll='l' data-scroll-x='{$idElement}' id='font' type='button' class='hidden -left-8 lg:flex absolute top-0 start-0 z-30 justify-center w-12 h-12 my-40 cursor-pointer text-black rounded-full text-6xl font-semibold text-gray-700 dark:text-gray-200 bg-gray-400/30 text-center p-0 active:bg-gray-600/30 focus:outline-none items-stretch'>
                        <
                      </button>
                      <button data-js='handelScrollX,click' data-direction-scroll='r' data-scroll-x='{$idElement}' id='font' type='button' class='hidden -right-8 lg:flex absolute top-0 end-0 z-30 justify-center w-12 h-12 my-40 cursor-pointer text-black rounded-full text-6xl font-semibold text-gray-700 dark:text-gray-200 bg-gray-400/30 text-center p-0 active:bg-gray-600/30 focus:outline-none items-stretch'>
                        >
                      </button>";
    }
    ...
    public function generateProductList(array $products, string $id)
    {
        ...
        foreach ($products as $productItem):
          ...
          <div class='text-center mt-4'>
            ...
            <button data-js='handelPost,click' data-route='http://{$_SERVER['HTTP_HOST']}/addtobasket/{$productItem->id}' type='button' class='w-full flex items-center justify-center gap-3 mt-6 px-4 py-2.5 bg-transparent hover:bg-gray-200 text-base text-[#333] border-2 font-semibold border-[#333] rounded-xl'>
