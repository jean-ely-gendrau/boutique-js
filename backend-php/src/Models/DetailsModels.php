...
class DetailsModels implements JsonSerializable
{
    /**
     * id
     *
     ...
     * Set url_images
     *
     * @param  string  $main_image  url_images
     *
     * @return  self
     */
    public function setMain_image(string $main_image)
    {
     ...
     * @return  string
     */
    public function getOther_images()
    {
     ...
     * Set other_images
     *
     * @param  string  $other_image  other_images
     *
     * @return  self
     */
    public function setOther_images(string $other_image)
    {
