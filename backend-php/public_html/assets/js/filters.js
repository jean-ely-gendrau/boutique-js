    ...
    productCard.innerHTML = `
          <div class="bg-gray-100 rounded-2xl p-6 cursor-pointer hover:-translate-y-2 transition-all relative">
              <div id="${product.id}" class="${inFav} favorites bg-gray-200 w-10 h-10 flex items-center justify-center rounded-full cursor-pointer absolute top-4 right-4">
                  <svg xmlns="https://www.w3.org/2000/svg" class="fill-gray-800 inline-block" width="22px" viewBox="0 0 192 192">
              ...
              <div class="text-center mt-4">
                  ...
                  <button data-js="handelPost,click" data-route="https://<?= $serverName ?>/addtobasket/${product.id}" type="button" class="w-full flex items-center justify-center gap-3 mt-6 px-4 py-2.5 bg-transparent hover:bg-gray-200 text-base text-[#333] border-2 font-semibold border-[#333] rounded-xl">
