        ...
        <div class="md:flex md:justify-between">
            <div class="mb-6 md:mb-auto">
                <a href="http://<?= $serverName ?>" class="flex items-center">
                    <img src="http://<?= $serverName ?>/assets/images/tea-coffee.png" class="h-8 me-3"
                        alt="TeaCoffee Logo" />
                ...
                <div class="flex content-col justify-between mt-5">
                    <div class="mx-2">
                        <div
                            class="mx-auto w-12 h-12 bg-gray-200 rounded-full p-2 hover:border hover:border-sky-500 cursor-pointer">
                            <a href="/information/livraison">
                                <img src="http://<?= $serverName ?>/assets/images/icon/icons_delivery_gray.png"
                                    alt="Icon de livraison" title="Condition de livraison" class="">
                            </a>
                        </div>
                    ...
                    <div class="mx-2">
                        <div
                            ...
                            <a href="/information/paiement">
                                <img src="http://<?= $serverName ?>/assets/images/icon/icons_creditcard_gray.png"
                                    alt="Icon de carte de crédit" title="Paiement sécuriser" class="">
                            </a>
                        </div>
                    ...
                    <div class="mx-2">
                        <div
                            class="mx-auto w-12 h-12 bg-gray-200 rounded-full p-2 hover:border hover:border-sky-500 cursor-pointer">
                            <a href="/contact">
                                <img src="http://<?= $serverName ?>/assets/images/icon/icons_contact_gray.png"
                                    alt="Icon de contact" title="Nous contacter" class="">
                            </a>
                        </div>
                    ...
                    <div class="mx-2">
                        <div
                            ...
                            <a href="/information/boutique">
                                <img src="http://<?= $serverName ?>/assets/images/icon/icons_store_gray.png"
                                    alt="Icon de boutique" title="Notre boutique" class="">
                            </a>
                        </div>
                        ...
                        <?php foreach ($bestProducts as $product): ?>
                            <li class="mb-4">
                                <a id="<?= $product->productId ?>"
                                    class="article-name cursor-pointer"><?= $product->productName ?></a>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                </div>
      ...
      */
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a
                    href="https://<?= $serverName ?>" class="hover:underline">TeaCoffe</a>. Tout droit réserver.
            </span>
            <div class="flex mt-4 sm:justify-center sm:mt-0">
                ...
                <a href="https://github.com/jean-ely-gendrau/boutique-js"
...
<script defer src="http://<?= $serverName ?>/assets/js/addtobasket.js"></script>
