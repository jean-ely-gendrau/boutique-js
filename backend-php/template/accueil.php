...
<div
  ...
  <button
    ...
    <div class="mt-8 md:mt-20 lg:flex lg:align-items bg-gray-100 p-2 rounded-xl shadow-[3px_3px_8px_0px_rgba(0,0,0,0.6)]">
         ...
         <div class="text-gray-700 dark:text-gray-200 ">
          ...
          <img src="https://<?= $serverName ?>/assets/images/banière/testBannerCoffee.png" class="w-[15rem] mx-auto md:w-[25rem] lg:w-[30rem] lg:h-[12rem]" alt="">
        </div>
    <div class="mx-auto lg:w-fit">
      <?= $productsCoffee ?>
    </div>
    ...
    <div class="lg:flex lg:align-items bg-gray-100 p-2 rounded-xl shadow-[3px_3px_8px_0px_rgba(0,0,0,0.6)] mt-8 md:mt-20">
         ...
         <div class="text-gray-700 dark:text-gray-200 ">
          ...
          <img src="https://<?= $serverName ?>/assets/images/banière/testBannerTea.png" class="w-[15rem] mx-auto md:w-[25rem] lg:w-[30rem] lg:h-[12rem]" alt="">
        </div>
    <div class="mx-auto lg:w-fit">
      <?= $productsTea ?>
    </div>
