<p>Bienvenue <?php echo $profil["full_name"] ?></p>
...
<div class="items-center">
    <a href="modification"
        ...
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
            src="http://<?= $serverName ?>/assets/images/image_modification.jpg" alt="image_modification_profil">
    ...
    <a href="historique"
        class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
            src="http://<?= $serverName ?>/assets/images/image_historique.jpg" alt=" image_historique_achat">
        <div class="flex flex-col justify-between p-4 leading-normal">
    ...
    <a href="panier"
        class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
            src="http://<?= $serverName ?>/assets/images/image_panier.jpg" alt="image_panier">
        <div class="flex flex-col justify-between p-4 leading-normal">
    ...
    <a href="wishlist"
        class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
        <img class="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
            src="http://<?= $serverName ?>/assets/images/wishlist.jpg" alt="image_panier">
        <div class="flex flex-col justify-between p-4 leading-normal">
