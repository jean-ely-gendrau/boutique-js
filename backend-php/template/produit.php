<div>
    ...
    <?php foreach ($mostSell as $sellMost) : ?>
        ...
        <div class="bg-gray-100 w-60 h-80 inline-block relative text-center m-2.5 rounded-x1">
            <div class="bg-grav-200 w-10 h-10 flex items-center justify-center rounded-full cursor-pointer absolute top-4 right-4">
            ...
            <img id="<?= $sellMost['id'] ?>" class="article-image" src="http://<?= $serverName ?>/assets/images/<?= $sellMost['url_image'] ?>" alt="<?= $sellMost['name'] ?>">
        ...
        foreach ($produitSql as $sqlProduit) :
            ...
            if (!empty($sqlProduit)) : ?>
                ...
                <div class="bg-gray-100 w-60 h-80 inline-block relative text-center m-2.5 rounded-x1'">
                    ...
                    <img id="<?= $sqlProduit['id'] ?>" class="article-image" src="http://<?= $serverName ?>/assets/images/<?= $sqlProduit['url_image'] ?>" alt="<?= $sqlProduit['name'] ?>">
