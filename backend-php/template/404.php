<section class="w-auto flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0 m-2 border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
  <div class="w-full flex flex-col md:flex-row items-center justify-between lg:px-2 xl:px-0 text-center">
    <div class="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
      ...
      <p class="text-lg md:text-xl lg:text-2xl text-gray-600 my-12 dark:text-gray-100"><?= $mvcException?->getMessage() ?? $clientException?->getMessage() ?? 'Désolé, la page que vous recherchez est introuvable.' ?></p>
      <a href="/" class="flex items-center space-x-2 bg-blue-600 hover:bg-blue-700 text-gray-100 dark:text-gray-200 px-4 py-2 rounded transition duration-150" title="Aller à la page Accueil de TeaCoffee">
    ...
    <div class="w-1/2 lg:h-full flex lg:items-end justify-center p-4">
      <svg width="696" height="578" viewBox="0 0 696 578" fill="none" xmlns="https://www.w3.org/2000/svg" xmlns:xlink="https://www.w3.org/1999/xlink">
        ...
        <defs>
          ...
          <image id="image0_0_1" width="4096" height="4096" xlink:href="https://<?= $serverName ?>/assets/images/404coffee.png" />
        </defs>
      </svg>
    </div>
  </div>
