...
class ModalBuilder extends AbstractModalBuilder
{
    ...
    public function render()
    {
        $output =
            '<div id="' .
            $this->idModal .
            '" tabindex="-1" class="fixed bottom-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] ">';
        $output .= '<div class="relative w-full max-h-full';
        $output .= $this->sizeModal ?? 'max-w-lg';
        $output .= '">';
        $output .= '<!-- Modal content -->';
        $output .= '<div class="relative bg-white rounded-lg shadow dark:bg-gray-700 mb-5 max-h-screen md:min-h-[525px] lg:max-h-screen overflow-y-auto">';
        /**************************************
